...
<?php if (!isLoggedIn()): ?>
    ...
    <?php else: ?>
        ...
        <?php elseif ($_SESSION['role'] === ROLE_ADMIN): ?>
            <li class="nav-item">
                <a class="nav-link text-warning fw-bold" href="<?= BASE_URL ?>admin/audit_logs.php"><i class="bi bi-shield-check"></i> Audit Logs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= BASE_URL ?>admin/profile.php">My Profile</a>
            </li>
        <?php endif; ?>
        
        <li class="nav-item">
            <a class="nav-link text-danger ms-lg-3" href="<?= BASE_URL ?>auth/logout.php"><i class="bi bi-box-arrow-right"></i> Logout</a>
        </li>
    <?php endif; ?>
